...
class Program
{
    static void Main(string[] args)
    {
        ...
        examCourseManager.AddCourse(new ExamCourse("DSA", "Computer Science", 100));

        examCourseManager.AddCourse(new ExamCourse("Mathematics", "Mathematics", 80));

        assignmentCourseManager.AddCourse(new AssignmentCourse("S.E", "Computer Science", 5));

        assignmentCourseManager.AddCourse(new AssignmentCourse("P.M", "Humanities", 3));
