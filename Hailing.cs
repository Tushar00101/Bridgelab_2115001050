...
abstract class Vehicle
{
    ...
    public Vehicle(int id, string drv, double rate)
    {
        vehicleId = id;
...
{
    public Car(int id, string drv, double rate) : base(id, drv, rate) { }

    public override double CalculateFare(double distance)
    {
        return ratePerKm * distance * 1.2; // 20% extra charge for comfort
    }
...
{
    public Bike(int id, string drv, double rate) : base(id, drv, rate) { }

    public override double CalculateFare(double distance)
    {
        return ratePerKm * distance * 0.8; // 20% discount for bikes
    }
...
{
    public Auto(int id, string drv, double rate) : base(id, drv, rate) { }
...
class Program
{
    static void Main()
    {
        ...
        vehicles.Add(new Car(101, "Sanyam", 10));
        
        vehicles.Add(new Bike(102, "Johny", 5));
        
        vehicles.Add(new Auto(103, "Mikey", 7));
