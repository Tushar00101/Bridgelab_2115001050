...
class Program
{
    static void Main(string[] args)
    {
        ...
        softwareEngineerResumes.AddCandidate(new SoftwareEngineer("Tushar", new List<string> { ".NET", "SQL Server", "MERN" }));
        ...
        dataScientistResumes.AddCandidate(new DataScientist("Kumar", new List<string> { "Python", "Data Visualization" }));
